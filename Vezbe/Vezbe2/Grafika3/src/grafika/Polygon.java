...
public class Polygon implements Serializable, Cloneable 
{
    ...
    public Polygon(Point2D.Double p1, Point2D.Double p2, Point2D.Double p3, Point2D.Double p4) 
    {
        this.p1 = p1;
        this.p2 = p2;
        this.p3 = p3;
    ...
    public void draw(DrawGrid grid) 
    {
        ...
        grid.drawLine((int) p4.getX(), (int) p4.getY(), (int) p4.getY(), (int) p4.getY(), true);
    }
    ...
    public void translate(int dx, int dy) 
    {
        ...
        p4.setLocation(p4.getX() + dx, p4.getY() + dy);
    }
